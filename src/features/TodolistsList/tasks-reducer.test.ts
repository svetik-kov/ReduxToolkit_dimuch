...
test('status of specified task should be changed', () => {
    const action = updateTask.fulfilled({taskId:'2', model:{status: TaskStatuses.New}, todolistId: 'todolistId2'
...
test('title of specified task should be changed', () => {
    const action = updateTask.fulfilled({taskId:'2',model: {title: 'yogurt'}, todolistId:'todolistId2'},'requestId',{taskId:'2',domainModel: {title: 'yogurt'}, todolistId:'todolistId2'});
